...
INSERT INTO `Ejercicio-6`.`Poliza` (TipoSeguro, FechaInicio, FechaExpiracion, MontoAsegurado, EstadoPoliza, Agente_idAgente, Cliente_idCliente, Vehiculo_idVehiculo, Hogar_idHogar, Prima, Descripcion, Condiciones, FechaUltimaActualzacion, `Contrato (URL)`)
VALUES
('Automovil', '2022-01-01', '2023-01-01', 15000.00, 1, 1, 1, 1, NULL, 500.00, 'Seguro de coche para Tesla Model X', 'Cobertura total', NOW(), 'https://contrato1.com'),
('Hogar', '2022-02-01', '2023-02-01', 100000.00, 1, 2, 2, NULL, 1, 400.00, 'Seguro de hogar en Barcelona', 'Cobertura contra incendios y robos', NOW(), 'https://contrato2.com'),
('Automovil', '2022-03-01', '2023-03-01', 12000.00, 1, 3, 3, 2, NULL, 450.00, 'Seguro de coche para Opel Astra', 'Cobertura estándar', NOW(), 'https://contrato3.com'),
('Hogar', '2022-04-01', '2023-04-01', 90000.00, 1, 4, 4, NULL, 400.00, 'Seguro de hogar en Valencia', 'Cobertura completa', NOW(), 'https://contrato4.com'),
('Automovil', '2022-05-01', '2023-05-01', 10000.00, 1, 5, 5, 3, NULL, 300.00, 'Seguro de coche para Honda Civic', 'Cobertura parcial', NOW(), 'https://contrato5.com'),
('Hogar', '2022-06-01', '2023-06-01', 95000.00, 1, 6, 6, NULL, 350.00, 'Seguro de hogar en Zaragoza', 'Cobertura contra robos', NOW(), 'https://contrato6.com');
